...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center max-w-[1240px] mx-auto px-4 h-24 text-white'>
      ...
      <div className={!nav ? 'fixed lg:hidde md:hidden left-0 top-0 w-[30%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' : 'fixed left-[-100%]'}>
        ...
        <ul className=' uppercase p-4'>
          ...
          <li className=' p-4 border-b border-gray-600 cursor-pointer text-white hover:text-gray-800 font-semibold'>Contact</li>
        </ul>
      </div>
    </div>
  );
